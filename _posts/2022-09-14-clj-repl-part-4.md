...
При новом запуске вы получите доступ ко всем возможностям Cider, что мы рассмотрели: навигации по коду, поиску пространств, запуску тестов, отладке и остальному. Однако бóльшая их часть пригодна только для локальных нужд. Применение их на боевом сервере несет скорее вред, чем пользу.
