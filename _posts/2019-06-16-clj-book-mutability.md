...
Транзиентные коллекции ползены на больших объемах данных, поскольку быстрее
...
Функция **alter-var-root** заменяет `def`-опредение на произвольное значение. С
...
логирование, улучить поведение чужой функции.
