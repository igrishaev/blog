...
Теперь внимание: **анонсирую предзаказ книги**. Чтобы получить ее на лучших
условиях, сделайте следующее:

- нажмите на кнопку оплаты;
- укажите ФИО, емейл и адрес доставки (ниже я объясню, зачем эти данные);
...
при печати Print on Demand, но в разовом тираж -- вполне. Таких книг будет мало,
