...
*TL;DR: [https://github.com/igrishaev/pg2][pg]*
...
### Benchmark 1. Querying a single-column, series-based query with 50000 rows
...
Since JDBC cannot binary encode data on the fly, I took then numbers from the
