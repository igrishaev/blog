---
layout: post
title:  "PG2 release 0.1.6: rich JSON capabilities"
permalink: /en/pg-json
lang: en
tags: clojure programming postgres sql json
---

[docs]: https://github.com/igrishaev/pg2/blob/master/README.md
[pg2]: https://github.com/igrishaev/pg2

[PG2 version 0.1.6][pg2] is out, and it ships various improvements to JSON(b)
handling.

{% include toc.html id="pg2-json" title="Table of Content" %}
