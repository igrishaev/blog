...
получили меньше таблиц и меньше кода. Задача решена простым и понятным способом.
...
То же самое относится к App Store: сервера Apple присылают огромные документы,
...
**Стандарты.** Иногда бизнес опирается на стандарты — соглашения о том, как
...
с одним пользователем, а с тысячами.
