---
layout: post
title:  "PG2 release 0.1.3: Next.JDBC-compatible API"
permalink: /en/pg-jdbc
lang: en
...
{% include toc.html id="pg2-jdbc" title="Table of Content" %}

[next-jdbc]: https://github.com/seancorfield/next-jdbc

[PG2 version 0.1.3][pg2] is out. One of its new features is a module which
mimics [Next.JDBC][next-jdbc] API. Of course, it doesn't cover 100% of Next.JDBC
...
For more information, please refer to the official [README file][docs].
